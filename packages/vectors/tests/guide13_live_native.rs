...
use target_elements_conformance::protocol::{
    ...
    ConfidentialFundingDestination, ConfidentialFundingProfiles, FundingCustodyProfile,
    FundingMaterializerProfile, FundingRepresentationProfile, NativeOperationResponse,
    ObservedOutcomeLayer, OperationCaseId, OperationSubject, TargetConfidentialFundingSubject,
    TargetConfidentialSponsorFundingSubject, TargetFundingSubject, TargetSponsorFundingSubject,
...
use vectors::live_report::{LiveMutantKind, LiveMutationLocator};

pub mod common;
use common::*;
include!("common/legacy.rs");
