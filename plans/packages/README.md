...
| [compiler.md](compiler.md) | Active — proof, placement, layout, and coverage foundations implemented internally; complete analyzed pilots open | Relation, proof, disclosure, lifecycle, placement, and layout analysis. |
