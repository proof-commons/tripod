...
| [attestation-floor-bounds.md](attestation-floor-bounds.md) | Analysis accepted; correction and regressions pending | Attestation containment and seigniorage claims, and the SP5 capacity export. |
