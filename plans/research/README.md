...
| [attestation-floor-bounds.md](attestation-floor-bounds.md) | Open; formal analysis required | Layer-0 containment and seigniorage claims, and the SP5 capacity export. |
| [notation-semantic-census.md](notation-semantic-census.md) | Open; prototype required | Layer-0 vocabulary integrity and the surface/core purity lint. |
