...
| [attestation-floor-bounds.md](attestation-floor-bounds.md) | Analysis accepted; correction and regressions pending | Layer-0 containment and seigniorage claims, and the SP5 capacity export. |
| [notation-semantic-census.md](notation-semantic-census.md) | Design accepted; implementation pending | Layer-0 vocabulary integrity and the surface/core purity lint. |
