...
Phase-4 work:
    ...
    against every acceptance and all eight matched. What remains under
    T4-008 is the five sponsored cases, which need a signing capability
    this package does not have and will not fabricate
```
